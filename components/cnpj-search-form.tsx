        ...
        <div>
          <div data-no-print className="flex items-center justify-between mb-3.5">
            ...
            <div className="flex gap-2.5">
              ...
              <button onClick={() => window.print()} className="inline-flex items-center gap-1.5 px-3.5 py-[7px] rounded-sm text-[12px] font-bold bg-[var(--violet)] text-white hover:bg-[var(--violet-dark)] transition-all">
